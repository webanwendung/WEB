...
response.sendRedirect("../jsp/FachbereichView.html");
...
else if  (register.equals("Tutor finden")){
	System.out.println("Tutor suchen-Button wurde geklickt");
response.sendRedirect("../jsp/Tutorfach.jsp");
