...
<div class="container">
	...
	<div class="row">
	 ...
	 <form action="../jsp/kontaktappl.jsp" method="get">
	<div class="row input-container">
			...
			<div class="col-xs-12">
				<div ><button  type="submit"  name="senden"  title="Send Message" value="Send_Message" class="btn-lrg submit-btn">Send Message</button></div>
			</div>
	</div>
	</form>
</div>
